...
import { bannerImageOne } from '../utils/constants'
...
function About() {
  return (
    <div className='max-w-7xl mx-auto px-4 py-8'>
     ...
     <div className='flex flex-col lg:flex-row justify-between items-center mb-12 gap-3'>
            <div className='w-full md:w-1/2 text-center md:text-left'>
                <p className='text-lg mb-4'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, recusandae incidunt odit voluptatum, minus consectetur veniam esse architecto eligendi corrupti laboriosam? Voluptatibus cupiditate optio eligendi adipisci. Voluptatibus cumque pariatur unde.
                </p>
            </div>
            <div className='w-full md:w-1/2 mb-6 md:mb-0'>
                <img src={bannerImageOne} alt="About us" 
                className='w-full h-auto rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105'/>
            </div>
     </div>
     <div className='py-7 space-y-8'>
        <h2 className='text-slate-800 text-4xl font-bold text-center '>Our Products</h2>
